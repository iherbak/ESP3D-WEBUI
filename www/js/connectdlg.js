...
function connectdlg(getFw) {
    ...
    showModal();
    //removeIf(production)
    connectsuccess("FW version:0.9.9X # FW target:grbl-embedded # FW HW:Direct SD # primary : /sd/ # secondary : /ext/ # authentication: no# webcommunication:socket:123#hostname:localhost#axis:3");
    return;
